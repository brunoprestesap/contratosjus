...
const STOPWORDS_PT = new Set([
  "de","da","do","para","e","a","o","os","as","em","com","sem","por","ao",
  "que","na","no","dos","das","pelo","pela","ou","um","uma","uns","umas",
  "sobre","entre","este","esta","isso","aqui","ali","lá","tipo","ser","ter",
  "bem","apenas","mais","menos","muito","pouco","aquisicao","aquisicão",
  "contratacao","contratacão","servico","servicos","servicos","serviço",
  "material","materiais","objeto","objetos","empresa","empresas",
  "destinada","destinado","destinados","destinadas","atender","atender",
]);
